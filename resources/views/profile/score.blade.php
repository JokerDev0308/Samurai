                ...
                <div class="col-4">
                    ...
                    @if($review['level']['projects'])
                        <div class="d-flex justify-content-center align-items-center my-2">
                            <img src="{{ asset("assets/img/reward/project-".$review['level']['projects'].".png") }}" alt="reward">
                        </div>
                    @endif
                </div>
                <div class="col-4">
                    ...
                    @if($review['level']['projects_view'])
                        <div class="d-flex justify-content-center align-items-center my-2">
                            <img src="{{ asset("assets/img/reward/attention-".$review['level']['projects_view'].".png") }}" alt="reward">
                        </div>
                    @endif
                </div>
                <div class="col-4">
                    ...
                    @if($review['level']['projects_end'])
                        <div class="d-flex justify-content-center align-items-center my-2">
                            <img src="{{ asset("assets/img/reward/contract-".$review['level']['projects_end'].".png") }}" alt="reward">
                        </div>
                    @endif
                </div>
                <div class="col-4">
                    ...
                    @if($review['level']['follow_cnt'])
                        <div class="d-flex justify-content-center align-items-center my-2">
                            <img src="{{ asset("assets/img/reward/following-".$review['level']['follow_cnt'].".png") }}" alt="reward">
                        </div>
                    @endif
                </div>
                <div class="col-4">
                    ...
                    @if($review['level']['followed_cnt'])
                        <div class="d-flex justify-content-center align-items-center my-2">
                            <img src="{{ asset("assets/img/reward/follower-".$review['level']['followed_cnt'].".png") }}" alt="reward">
                        </div>
                    @endif
                </div>
                <div class="col-4">
                    ...
                    @if($review['level']['invites'])
                        <div class="d-flex justify-content-center align-items-center my-2">
                            <img src="{{ asset("assets/img/reward/friend-".$review['level']['invites'].".png") }}" alt="reward">
                        </div>
                    @endif
                </div>
            </div>
...
@section('script')
    <script src="{{ asset('assets/lib/apexcharts.js') }}"></script>
    <script>
        var review = @json($review);
    </script>
    <script src="{{ asset('assets/js/page-score.js') }}"></script>
@endsection
