...
@section('script')
    ...
    <script src="{{ asset('assets/lib/anychart/anychart-core.min.js') }}"></script>
    <script src="{{ asset('assets/lib/anychart/anychart-radar.min.js') }}"></script>
    <script src="{{ asset('assets/lib/apexcharts.js') }}"></script>
    <script>
        var review = @json($review);
    </script>
    <script src="{{ asset('assets/js/page-profile-agent.js') }}"></script>
@endsection
