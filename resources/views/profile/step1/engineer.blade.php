        ...
        <div class="col-form-input available-days-week">
            @foreach($weeks as $week)
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="availableDaysWeek" id="availableDaysWeek{{ $week->id }}" value="{{ $week->id }}" @if(isset($profile)) @if($week->id === $profile->week) {{ 'checked' }} @endif @endif>
                ...
                @foreach($profile->portfolios as $port)
                    <div class="col-form-input-item">
                        ...
                        <div class="mt18 row image-picker">
                            ...
                            @else
                                <img src="{{ asset('assets/img/icon-image.png') }}" alt="">
                            @endif
    ...
    <div class="form-group">
        ...
        <div class="col-form-input remote-work">
            @foreach($remote_works as $remote)
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="remote" id="remote{{ $remote->id }}" value="{{ $remote->id }}" @if(isset($profile)) @if($remote->id === $profile->remote_work_id) {{ 'checked' }} @endif @endif>
        ...
        <div class="col-form-input col-join-date">
            <div class="col-form-input-item">
                <div class="mt18">
                    ...
                    <span class="icon-calendar"><img src="{{ asset('assets/img/calendar.png') }}" alt=""></span>
                </div>
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-form-input col-dress">
            @foreach($dresses as $dress)
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="dress" id="dress{{ $dress->id }}" value="{{ $dress->id }}" @if(isset($profile))  @if($dress->id === $profile->dress_id) {{ 'checked' }} @endif @endif>
