    ...
    <div class="container">
        <div class="profile-header row">
            <div class="user-follow col-md-4">
                <img src="{{ isset($profile) && $profile->user->avatar ? upload_asset($profile->user->avatar) : asset('assets/img/avatar/default.png') }}" alt="" class="avatar-img">
            ...
            <div class="col-md-4 text-left">
                <p><div class="row">
                    <div class="col-md-3"><img src="{{ asset('assets/img/icon-light.png') }}"></div>
                ...
                <p><div class="row">
                    <div class="col-md-3"><img src="{{ asset('assets/img/icon-calendar.png') }}"></div>
                    <div class="col-md-9" id="profile-week">週{{ isset($profile->week) ? $profile->week : '5' }}日</div>
                </div></p>
                <p><div class="row">
                    <div class="col-md-3"><img src="{{ asset('assets/img/icon-handshake.png') }}"></div>
            ...
            <div class="col-md-4">
                ...
                <a href="tel:{{ isset($profile)? $profile->user->phone:''}}" class="btn btn-theme btn-call d-flex justify-content-center align-items-center">電話で話を聞く</a>
            </div>
        </div>
    </div>
