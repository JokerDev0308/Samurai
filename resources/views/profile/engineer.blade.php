    ...
    <section class="content-section">
        <div class="applicant-profile-input">
            ...
            <div class="step-content{{ $step == 1 ? ' active': '' }}" data-step="1">
                @include('profile.step1.engineer')
            </div>
            ...
            <div class="step-content{{ $step == 3 ? ' active': '' }}" data-step="3">
                ...
                <div class="applicant-profile-completion-buttons d-flex justify-content-center">
                    <button class="btn btn-black" onclick="javascript: location.href = '{{ route('engineer.dashboard') }}'">ダッシュボード</a>
...
@section('script')
    ...
    <script src="{{ asset('assets/js/page-profile-engineer.js') }}"></script>
@endsection
