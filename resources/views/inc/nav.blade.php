    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-sm navbar-light">
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('assets/img/logo/logo.png') }}" class="img-fluid" alt="">
            </a>
                    ...
                    @if (!isAdmin())
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('*.dashboard') ? 'active' : '' }}" href="{{ route('home') }}">
                                <img src="{{ asset('assets/img/folder.png') }}" class="icon-list" alt="list icon" />
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('user.*') ? 'active' : '' }}" href="{{ route('user.follow.list') }}">
                                <img src="{{ asset('assets/img/contact.png') }}" class="icon-list" alt="list icon" />
                            </a>
                        </li>
                        @if(isAgent())
                            <li class="nav-item">
                                <a class="nav-link {{ Request::routeIs('agent.score') ? 'active' : '' }}" href="{{ route('agent.score') }}">
                                    <img src="{{ asset('assets/img/chart.png') }}" class="icon-list" alt="list icon" />
                                </a>
                            </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <img src="{{ asset('assets/img/clipboard.png') }}" class="icon-list" alt="list icon" />
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('chat.*') ? 'active' : '' }}" href="{{ route('chat.index') }}">
                                <img src="{{ asset('assets/img/chat.png') }}" class="icon-list" alt="list icon" />
