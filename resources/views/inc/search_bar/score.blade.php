            ...
            <div class="sidebar-item-content row mb-3">
                ...
                <div class="col-6">
                    ...
                    <p class="text-center mb-0">
                        ...
                        @endphp
                        <img src="{{ asset("assets/img/ribon$ribon.png") }}" class="mr-1">
                ...
                @foreach($projects as $el)
                    ...
                    <div class="collapse" id="project{{ $el->id }}">
                        <div class="d-flex flex-wrap justify-content-center px-4">
                            <img src="{{ asset('assets/img/reward/project-'.$el->level.'.png') }}" alt="reward" class="w-50 mx-5">
        ...
        <div class="sidebar-item">
            ...
            <div class="sidebar-list-content">
                @foreach($projects_view as $el)
                    ...
                    <div class="collapse" id="project{{ $el->id }}">
                        <div class="d-flex flex-wrap justify-content-center px-4">
                            <img src="{{ asset('assets/img/reward/attention-'.$el->level.'.png') }}" alt="reward" class="w-50 mx-5">
                            <p class="my-3">{{ $el->description }}</p>
        ...
        <div class="sidebar-item">
            ...
            <div class="sidebar-list-content">
                @foreach($projects_end as $el)
                    ...
                    <div class="collapse" id="project{{ $el->id }}">
                        <div class="d-flex flex-wrap justify-content-center px-4">
                            <img src="{{ asset('assets/img/reward/contract-'.$el->level.'.png') }}" alt="reward" class="w-50 mx-5">
                            <p class="my-3">{{ $el->description }}</p>
        ...
        <div class="sidebar-item">
            ...
            <div class="sidebar-list-content">
                @foreach($follow_cnt as $el)
                    ...
                    <div class="collapse" id="project{{ $el->id }}">
                        <div class="d-flex flex-wrap justify-content-center px-4">
                            <img src="{{ asset('assets/img/reward/following-'.$el->level.'.png') }}" alt="reward" class="w-50 mx-5">
                            <p class="my-3">{{ $el->description }}</p>
        ...
        <div class="sidebar-item">
            ...
            <div class="sidebar-list-content">
                @foreach($followed_cnt as $el)
                    ...
                    <div class="collapse" id="project{{ $el->id }}">
                        <div class="d-flex flex-wrap justify-content-center px-4">
                            <img src="{{ asset('assets/img/reward/follower-'.$el->level.'.png') }}" alt="reward" class="w-50 mx-5">
                            <p class="my-3">{{ $el->description }}</p>
        ...
        <div class="sidebar-item">
            ...
            <div class="sidebar-list-content">
                @foreach($invites as $el)
                    ...
                    <div class="collapse" id="project{{ $el->id }}">
                        <div class="d-flex flex-wrap justify-content-center px-4">
                            <img src="{{ asset('assets/img/reward/friend-'.$el->level.'.png') }}" alt="reward" class="w-50 mx-5">
                            <p class="my-3">{{ $el->description }}</p>
