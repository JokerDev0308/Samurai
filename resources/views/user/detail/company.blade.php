                    ...
                    @foreach($projects as $project)
                        <div class="content-case-entry for-company">
                            <div class="img-thumbnail-preview">
                                @if(isset($project))
                                    <img src="{{ $project->image ? upload_asset($project->image) : asset('assets/img/project-thumb.jpg') }}" class="object-cover-center" alt="">
                                @else
                                    <img src="{{ old('imagePath') ? upload_asset(old('imagePath')) : asset('assets/img/project-thumb.jpg') }}" class="object-cover-center" alt="">
                                @endif
                            </div>
                            ...
                            <div class="publisher">
                                <img src="{{ $project->user->avatar ? upload_asset($project->user->avatar) : asset('assets/img/avatar/default.png') }}" class="object-cover-center" alt="">
            ...
            <div class="container">
                ...
                <div class="content-no-posted for-corporate-dashboard">
                    <div class="d-flex justify-content-center">
                        <img src="{{ asset('assets/img/no_project.png') }}" alt="">
                    </div>
                </div>
            </div>
        </section>
...
@section('script')
    {{-- <script src="{{ asset('assets/js/page-user-agent.js') }}"></script> --}}
@endsection
