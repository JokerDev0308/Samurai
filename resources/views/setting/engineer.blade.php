                    ...
                    <div class="content-member-input">
                        <div class="step-wizard d-flex justify-content-center">
                            <div class="content-step-wizard d-flex justify-content-between">
                                ...
                                <div class="step-item{{ $step > 2 ? ' active': '' }}" data-step="3">登録</div>
                            </div>
                        </div>
                        <div class="step-content{{ $step == 1 ? ' active': '' }}" data-step="1">
                            <form method="POST" role="form" action="{{ route('engineer.update') }}" enctype="multipart/form-data" id="form">
                                @csrf
                                <input type="hidden" name="id" value="{{ $engineer->id }}">
                                <input type="hidden" name="avatarPath" id="avatarPath" value="{{ $engineer->avatar }}">
                                <div class="d-flex justify-content-center avatar-picker">
                                    <img src="{{ $engineer->avatar ? upload_asset($engineer->avatar) : asset('assets/img/avatar/default.png') }}" alt="" class="avatar-img">
                                    <input type="file" id="avatar" name="avatar" accept="image/*">
                                </div>
                                <div class="form-group row">
                                    <label for="name" class="col-sm-5 col-form-label">氏名</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ $engineer->name }}" id="name" name="name" placeholder="山田 太郎"  required maxlength="255">
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control{{ $errors->has('nameKana') ? ' is-invalid' : '' }}" value="{{ $engineer->name_kana }}" id="nameKana" name="nameKana" placeholder="山田 太郎" required maxlength="255">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ $engineer->phone }}" id="phone" name="phone" placeholder="080-0000-0000" required>
                                        @if ($errors->has('phone'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ $engineer->email }}" id="email" name="email" placeholder="example@example.com" required>
                                        @if ($errors->has('email'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="email" class="form-control{{ $errors->has('email_confirmation') ? ' is-invalid' : '' }}" value="{{ $engineer->email }}" id="confirmEmail" name="email_confirmation" placeholder="上記同様のメールアドレスをご入力ください" required data-parsley-equalto="#email">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" name="password" placeholder="password" minlength="6" maxlength="20" data-parsley-error-message="半角英数字記号6文字以上20文字以内で入力してください" data-parsley-pattern="/^[a-zA-Z0-9!@#$%^&*]{6,20}$/">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="password" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" id="password-confirm" name="password_confirmation" placeholder="上記同様のパスワードをご入力ください" data-parsley-equalto="#password" data-parsley-required-message="半角英数字記号6文字以上20文字以内で入力してください" data-parsley-pattern-message="半角英数字記号6文字以上20文字以内で入力してください" data-parsley-pattern="/^[a-zA-Z0-9!@#$%^&*]{6,20}$/">
                        ...
                        <div class="step-content{{ $step == 2 ? ' active': '' }}" data-step="2">
                            ...
                            <div class="input-preview row">
                                ...
                                <div class="col-sm-7 preview-value" data-for="name">{{ $engineer->name }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>氏名(カナ)</label>
                                </div>
                                <div class="col-sm-7 preview-value" data-for="nameKana">{{ $engineer->name_kana }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>電話番号</label>
                                </div>
                                <div class="col-sm-7 preview-value" data-for="phone">{{ $engineer->phone }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>メールアドレス</label>
                                </div>
                                <div class="col-sm-7 preview-value" data-for="email">{{ $engineer->email }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>パスワード</label>
                        ...
                        <div class="step-content{{ $step == 3 ? ' active': '' }}" data-step="3">
                            ...
                            <div class="member-input-btn d-flex justify-content-center">
                                <a href="{{ route('engineer.dashboard') }}" class="btn btn-theme btn-medium d-flex align-items-center justify-content-center">ダッシュボードへ</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            stepContent1.find('.avatar-picker img').click(function (e) {
                $('.avatar-picker img').attr('src', '{{ asset('assets/img/avatar/default.png') }}');
                inputAvatar.click();
            });
