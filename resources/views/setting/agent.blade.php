                ...
                <div class="col-md-12 d-flex justify-content-center">
                    <div class="content-member-input">
                        ...
                        <div class="step-content{{ $step == 1 ? ' active': '' }}" data-step="1">
                            <form method="POST" role="form" action="{{ route('agent.update') }}" enctype="multipart/form-data" id="form">
                                @csrf
                                <input type="hidden" name="id" value="{{ $agent->id }}">
                                <input type="hidden" name="avatarPath" id="avatarPath" value="{{ $agent->avatar }}">
                                <div class="d-flex justify-content-center avatar-picker">
                                    <img src="{{ $agent->avatar ? upload_asset($agent->avatar) : asset('assets/img/avatar/default.png') }}" alt="" class="avatar-img">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control{{ $errors->has('nameKana') ? ' is-invalid' : '' }}" value="{{ $agent->name_kana }}" id="nameKana" name="nameKana" placeholder="山田 太郎" required maxlength="255">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ $agent->phone }}" id="phone" name="phone" placeholder="080-0000-0000" required>
                                        @if ($errors->has('phone'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ $agent->email }}" id="email" name="email" placeholder="example@example.com" required>
                                        @if ($errors->has('email'))
                                            <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="email" class="form-control{{ $errors->has('email_confirmation') ? ' is-invalid' : '' }}" value="{{ $agent->email }}" id="confirmEmail" name="email_confirmation" placeholder="上記同様のメールアドレスをご入力ください" required data-parsley-equalto="#email">
                        ...
                        <div class="step-content{{ $step == 2 ? ' active': '' }}" data-step="2">
                            ...
                            <div class="input-preview row">
                                ...
                                <div class="col-sm-7 preview-value" data-for="name">{{ $agent->name }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>氏名(カナ)</label>
                                </div>
                                <div class="col-sm-7 preview-value" data-for="nameKana">{{ $agent->name_kana }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>電話番号</label>
                                </div>
                                <div class="col-sm-7 preview-value" data-for="phone">{{ $agent->phone }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>メールアドレス</label>
                                </div>
                                <div class="col-sm-7 preview-value" data-for="email">{{ $agent->email }}</div>
                            </div>
                            <div class="input-preview row">
                                <div class="col-sm-5 preview-label">
                                    <label>パスワード</label>
