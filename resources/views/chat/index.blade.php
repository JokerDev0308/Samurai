                ...
                @foreach($channels as $ch)
                    <li class="chat-user {{ isset($channel) ? ($ch->id == $channel->id ? 'active' : '') : '' }} {{ $ch->unread ? 'has-new-message' : '' }}">
                        <a href="{{ route('chat.channel', ['channelId' => $ch->id]) }}">
                            <img src="{{ $ch->opponent->avatar ? upload_asset($ch->opponent->avatar) : asset('assets/img/account.png') }}" alt="" class="chat-user-avatar object-cover-center">
                        ...
                        @foreach($messages as $message)
                            ...
                            <div class="chat-message">
                                <div class="chat-message-user">
                                    <img src="{{ $message->user_from->avatar ? upload_asset($message->user_from->avatar) : asset('assets/img/account.png') }}" class="avatar" alt="">
                                </div>
