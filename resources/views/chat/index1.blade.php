                    ...
                    <div class="chat-messages" id="chat-messages">
                        <div class="chat-message">
                            <div class="chat-message-user">
                                <img src="{{ $friend->avatar ? upload_asset($friend->avatar) : asset('assets/img/account.png') }}" class="avatar" alt="">
...
@section('script')
    ...
    <script src="{{ asset('assets/lib/dropzone.min.js') }}"></script>
                ...
                .done(function( response ) {
                    if(response.success) {
                        ...
                        response.channels.forEach(function (channel) {
                            const avatar = channel.avatar ? ('{{ upload_asset('') }}/' + channel.avatar) : '{{ asset('assets/img/avatar/default.png') }}';
                            ...
                            if(elChatMessages) {
                                response.messages.forEach(function (message) {
                                    ...
                                    elChatMessages.append('<div class="chat-message">' +
                                        '<div class="chat-message-user">' +
                                        '<img src="' + (chatUser.avatar ? ('{{ upload_asset('') }}/' + chatUser.avatar) : '{{ asset('assets/img/avatar/male.png') }}') + '" class="avatar" alt="">' +
