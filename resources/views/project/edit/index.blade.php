        ...
        <div class="edit-content">
            <div class="user-contact">
                <div class="image-upload-preview d-flex flex-column align-items-center">
                    <img src="{{ Auth::user()->avatar ? upload_asset(Auth::user()->avatar) : asset('assets/img/account.png') }}" class="object-cover-center" alt="{{ Auth::user()->name }}">
...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('assets/lib/jquery.timepicker/jquery.timepicker.css') }}">
@endsection
...
@section('script')
    <script type="text/javascript">
        ...
        const img_thumbnail_preview = '{{ asset('assets/img/icon-image.png') }}';
    </script>
    <script src="{{ asset('assets/lib/jquery.timepicker/jquery.timepicker.js') }}"></script>
